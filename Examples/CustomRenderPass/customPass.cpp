...
void CustomPass::Prepare(){
    ...
    auto graphicsRenderPass = std::make_unique<XRLib::Graphics::VkGraphicsRenderpass>(core, false, swapchain->GetSwapchainImages(), std::move(descriptorSets), vertexShaderPath, fragmentShaderPath);
